...
VERSION_FILES := VERSION pyproject.toml charts/adsb-notifier/Chart.yaml charts/adsb-notifier/values.yaml ui/index.html ui/js/bootstrap.js ui/js/config-flow.js ui/js/dashboard.js ui/js/forms.js ui/js/map-utils.js ui/js/modal.js ui/js/rule-actions.js ui/js/rule-model.js ui/js/state.js ui/js/theme.js ui/js/ui-utils.js ui/js/validation.js adsb_notifier/version.py docs/DEVELOPMENT.md docs/VERSIONING.md README.md Dockerfile Dockerfile.api Dockerfile.ui Makefile tests/test_versioning.py
...
help:
	@printf '%s\n' \
		...
		'  make bump-version NEW_VERSION=0.0.7  Bump project/component version files' \
		'' \
		'Common overrides:' \
...
bump-version:
	@test -n "$(NEW_VERSION)" || { echo "Usage: make bump-version NEW_VERSION=0.0.7"; exit 1; }
