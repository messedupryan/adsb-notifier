...
The project is currently in beta and uses SemVer-style `0.x.y` versions, with explicit release-candidate builds like `0.1.3-rc.1` before stable cuts like `0.1.3`. The worker, API, UI, Helm chart, Python package, and container images share the project version during beta.
